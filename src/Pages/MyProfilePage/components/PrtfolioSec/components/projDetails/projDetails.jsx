...
import webProjectList from '../prjctsList/prjctsList'
...
export default function WbDetails(props) {
  ...
  const clickedWebsite = webProjectList.find(project => project.name === prjctName[0] && project.description === prjctName[1])
              ...
              <div className='wbstImages-container'>
                ...
                <div className='wbstDtails'>
                  ...
                  <p className='url-container'>
                    {clickedWebsite.web_link && <b>URL:</b>} <a href={clickedWebsite.web_link} target="_blank" rel="noopener noreferrer">{clickedWebsite.web_link}</a>
                  </p>
                  <p className='wbsteExplntn'>{clickedWebsite.description}</p>
                  <div className='goTogitHub-button-container'>
                    <a href={clickedWebsite.documentation_link} target='_blank' rel='noopener noreferrer'>
                      <button>Go to GitHub / Documentation link</button>
                    </a>
                  </div>
                </div>
